...
module.exports = React.createClass({
    ...
    render: function () {
        ...
        for (var i = 0; i < this.props.groups.length; i++) {
            g.push(<Item id={this.props.groups[i].roomId} cate='groups' key={this.props.groups[i].roomId} username={this.props.groups[i].name} groupName={this.props.groups[i].groupName}
